...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "zhibin wang"
  # spec.authors            = { "zhibin wang" => "zhibin.wang@net263.com" }
  # spec.social_media_url   = "https://twitter.com/zhibin wang"
  ...
  spec.source       = { :git => "https://github.com/zouzijidelu/WZBModuleDemo.git", :tag => s.version.to_s }
